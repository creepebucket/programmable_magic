...
public class HeatExchangerScreen extends MachineScreen<HeatExchangerMenu> {
	...
	public void buildWidget() {
		...
		addWidget(new MachineWidgets.MachineInfoWindow(fromCenter(-175, -100), fromTopLeft(350, 70), menu.manaPowerW, Component.translatable("gui.arcanism.machine.mana_type.temperature"),
				Component.translatable("gui.arcanism.machine.type.heat_exchanger"), Component.translatable("gui.arcanism.machine.main_text.current_power"), literal("P="), "W"));
