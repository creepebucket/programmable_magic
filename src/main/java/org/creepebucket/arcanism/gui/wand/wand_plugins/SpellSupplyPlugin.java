...
import org.creepebucket.arcanism.gui.wand.WandSlots;
import org.creepebucket.arcanism.gui.wand.WandWidgets;
import org.creepebucket.arcanism.registries.SpellRegistry;
...
public class SpellSupplyPlugin extends BasePlugin {
    ...
    public void onAdd(WandScreen screen) {
        ...
        screen.lockButton = (SelectableImageButtonWidget) new SelectableImageButtonWidget(fromTopLeft(7, finalDy - 28), fromTopLeft(80, 16),
                ...
                .selectedTexture(Identifier.fromNamespaceAndPath(MODID, "textures/gui/ui/wand_unlock_button.png")).tooltip(Component.translatable("gui.arcanism.wand.spells.unlock_custom")).dy(supplyDy).mainColor(screen.mainColor);
    ...
    public Component function() {
        return Component.translatable("gui.arcanism.wand.plugin.mana_mult_mult")
