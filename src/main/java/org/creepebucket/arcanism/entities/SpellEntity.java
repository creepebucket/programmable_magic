package org.creepebucket.arcanism.entities;
...
import org.creepebucket.arcanism.spells.SpellEffects;
...
public class SpellEntity extends Entity {
    ...
    public void tick() {
        ...
        if (forcedChunkPos == null) {
            Arcanism.SPELL_ENTITY_TICKET_CONTROLLER.forceChunk(serverLevel, this, currentChunkPos.x(), currentChunkPos.z(), true, false);
            forcedChunkPos = currentChunkPos;
        } else if (forcedChunkPos.x() != currentChunkPos.x() || forcedChunkPos.z() != currentChunkPos.z()) {
            Arcanism.SPELL_ENTITY_TICKET_CONTROLLER.forceChunk(serverLevel, this, forcedChunkPos.x(), forcedChunkPos.z(), false, false);
            Arcanism.SPELL_ENTITY_TICKET_CONTROLLER.forceChunk(serverLevel, this, currentChunkPos.x(), currentChunkPos.z(), true, false);
            forcedChunkPos = currentChunkPos;
        }
