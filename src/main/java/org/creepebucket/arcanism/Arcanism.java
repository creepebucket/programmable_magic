...
import org.creepebucket.arcanism.client.ClientEventHandler;

import org.creepebucket.arcanism.data.ModDataGenerators;
import org.creepebucket.arcanism.events.CapabilityHandler;
import org.creepebucket.arcanism.registries.*;
...
public class Arcanism {
    ...
    public Arcanism(IEventBus modEventBus, ModContainer modContainer) {
