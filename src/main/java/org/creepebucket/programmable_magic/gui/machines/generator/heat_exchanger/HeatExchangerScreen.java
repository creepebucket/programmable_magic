...
public class HeatExchangerScreen extends MachineScreen<HeatExchangerMenu> {
	...
	public void buildWidget() {
		...
		addWidget(new MachineWidgets.MachineInfoWindow(fromCenter(-175, -100), fromTopLeft(350, 70), menu.manaPowerW, literal("温度/Tem"),
				literal("热交换机"), literal("[当前功率]"), literal("P="), "W"));
