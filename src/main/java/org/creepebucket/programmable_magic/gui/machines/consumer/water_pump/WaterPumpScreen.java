...
public class WaterPumpScreen extends MachineScreen<WaterPumpMenu> {
	...
	public void buildWidget() {
		...
		addWidget(new MachineWidgets.MachineInfoWindow(fromCenter(-125, -70), fromTopLeft(250, 80), menu.power, Component.translatable("gui.programmable_magic.machine.mana_type.momentum"),
				Component.translatable("gui.programmable_magic.machine.type.water_pump"), Component.translatable("gui.programmable_magic.machine.main_text.flow_per_second"), literal("Q="), "L"));
		...
		var info = new MachineWidgets.PowerInfoWindow(fromCenter(-90, -40), fromTopLeft(180, 80), Component.translatable("gui.programmable_magic.machine.water_pump.power_expr"));
		addWidget(info.disable());
		info.addPowerInfoItem(Component.translatable("gui.programmable_magic.machine.water_pump.base_flow_item"), DynamicValue.staticValue(1000d), literal("L/s"));
		info.addPowerInfoItem(Component.translatable("gui.programmable_magic.machine.water_pump.overclock_item"), menu.powerFact, literal("x"));
