...
public class SteamTurbineScreen extends MachineScreen<SteamTurbineMenu> {
	...
	public void buildWidget() {
		...
		addWidget(new MachineWidgets.MachineInfoWindow(fromCenter(-175, -100), fromTopLeft(350, 70), menu.manaPowerW, literal("动量/Mom"),
				literal("蒸汽轮机"), literal("[当前功率]"), literal("P="), "W"));
		...
		controlWindow.addChild(new SwitchWidget(fromTopRight(-7, 16), fromTopLeft(50, 19), literal("停机"), literal("销毁"), menu.voidOverflow).rightAlign());
	}
}
