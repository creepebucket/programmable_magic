package org.creepebucket.programmable_magic.gui.machines.generator.steam_turbine;
...
public class SteamTurbineScreen extends MachineScreen<SteamTurbineMenu> {
	...
	public void buildWidget() {
		...
		addWidget(new MachineWidgets.MachineInfoWindow(fromCenter(-175, -100), fromTopLeft(350, 70), menu.manaPowerW, Component.translatable("gui.programmable_magic.machine.mana_type.momentum"),
				Component.translatable("gui.programmable_magic.machine.type.steam_turbine"), Component.translatable("gui.programmable_magic.machine.main_text.current_power"), literal("P="), "W"));
