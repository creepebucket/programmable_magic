...
public class WandScreen extends Screen<WandMenu> {
    ...
    public void buildWidget() {
        ...
        addWidget(new TextWidget(fromBottomLeft(95 + 16, -76 - 10), Component.translatable("gui.programmable_magic.wand.inventory"))
        ...
        bar.addChild(new TextWidget(fromTopLeft(16, 3), Component.translatable("gui.programmable_magic.wand.inventory.plugins")).color(textColor));
