...
public class MediumManaBufferBlockEntity extends NetNodeBlockEntity implements GeoBlockEntity {
	...
	public static void tick(Level level, BlockPos pos, BlockState state, MediumManaBufferBlockEntity entity) {
		if (level.isClientSide()) return;

		entity.getNetworkData().setCache(new Mana(5e9, 5e9, 5e9, 5e9));

		if (level.getBlockEntity(pos.above(3)) instanceof NetNodeBlockEntity nodeBe) {
