...
public class LargeManaBufferBlockEntity extends NetNodeBlockEntity implements GeoBlockEntity {
	...
	public static void tick(Level level, BlockPos pos, BlockState state, LargeManaBufferBlockEntity entity) {
		if (level.isClientSide()) return;

		entity.getNetworkData().setCache(new Mana(3e10, 3e10, 3e10, 3e10));

		if (level.getBlockEntity(pos.above(4)) instanceof NetNodeBlockEntity nodeBe) {
